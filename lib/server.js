...
var Bitcore = require('bitcore-lib-joli');
var Bitcore_ = {
  JOLI: Bitcore
};
 ...
 * @param {string} opts.coin[='JOLI'] - The coin for this wallet (JOLI).
 * @param {string} opts.network[='livenet'] - The Jolicoin network for this wallet.
 ...
 * @param {string} opts.coin[='JOLI'] - The expected coin for this wallet (JOLI).
 ...
 * @param {string} opts.unit - Jolicoin unit used to format amounts in notifications.
 */
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['JOLI', 'bit'], value.toLowerCase()); //TODOWHAT is BIT???? is it BCH?
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='JOLI'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'JOLI'] - The coin to estimate fee levels from.
 * @param {string} [opts.network = 'livenet'] - The Jolicoin network to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'JOLI'] - The coin for this transaction.
 * @param {string} [opts.network = 'livenet'] - The Jolicoin network for this transaction.
